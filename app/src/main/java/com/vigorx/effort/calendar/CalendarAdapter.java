...
public class CalendarAdapter extends BaseAdapter {
	...
	private int positionToClockedIndex(int position) {
		int index = -1;
		int compYear = Integer.parseInt(currentYear) - Integer.parseInt(startDate.split("-")[0]);
		int compMonth = Integer.parseInt(currentMonth) - Integer.parseInt(startDate.split("-")[1]);
		if (compYear == 0 && (compMonth == 0 || compMonth == 1)) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.custom_calendar_item, null);
		}
