...
public class CalendarView extends LinearLayout implements OnClickListener {
	...
	private boolean clockedRecords[] = {true, true, true, false, false, false, true, true, true, true, false, false, false, true, true, true, true, false, false, false, true, true, true, true, false, false, false, true};
	...
	private void initView() {
		...
		calV = new CalendarAdapter(mContext, getResources(), jumpMonth, jumpYear, year_c, month_c, day_c, clockedRecords);
		addGridView();
	...
	private void enterNextMonth(int gvFlag) {
		...
		jumpMonth++; // 下一个月
		calV = new CalendarAdapter(mContext, this.getResources(), jumpMonth, jumpYear, year_c, month_c, day_c, clockedRecords);
		gridView.setAdapter(calV);
